...
describe PlanningsController do
  ...
  let(:valid_attributes) { { "incident_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved planning as @planning" do
        ...
        post :create, {:planning => { "incident_name" => "invalid value" }}, valid_session
        assigns(:planning).should be_a_new(Planning)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested planning" do
        ...
        Planning.any_instance.should_receive(:update).with({ "incident_name" => "MyString" })
        put :update, {:id => planning.to_param, :planning => { "incident_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the planning as @planning" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Planning.any_instance.stub(:save).and_return(false)
        put :update, {:id => planning.to_param, :planning => { "incident_name" => "invalid value" }}, valid_session
        assigns(:planning).should eq(planning)
      end
